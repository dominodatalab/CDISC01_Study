...
* Sponsor              : Domino
* Study                : CDISC01
* Program              : t_vscat.sas  (jenner-check bundle)
* Purpose              : Create the Categorical Summary Table (Vital Signs)
* ____________________________________________________________________________
* Adapted for the jenner-check bundle from prod/tfl/t_vscat.sas (the interactive
* DOMINO_IS_WORKFLOW_JOB=false branch). The analysis is unchanged. Adaptations:
*   - %include "/mnt/code/domino.sas" replaced by the bundled mock ADVS (autoexec)
*   - the program's own safe default DisplayName/Title/Footer macro vars are kept
...
/* Program name and safe defaults for TFL title/footer macro vars */
%global __prog_name DisplayName DisplayTitle Title1 Footer1 Footer2 Footer3;
