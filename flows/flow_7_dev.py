...
environment_name="Altair SLC 2026"
...
# pyflyte run --remote ./flows/flow_7_dev.py SDTM_ADaM_TFL_SLC --sdtm_dataset_snapshot /mnt/imported/data/SDTMBLIND --metadata_snapshot /mnt/data/METADATA 
...
@workflow
def SDTM_ADaM_TFL_SLC(sdtm_dataset_snapshot: str, metadata_snapshot: str):
    ...
    t_pop_task = run_domino_job_task(
        ...
        command="prod/tfl/t_pop_slc.sas",
    ...
    t_ae_rel_task = run_domino_job_task(
        ...
        command="prod/tfl/t_ae_rel_slc.sas",
        inputs=[Input(name="adsl_dataset", type=FlyteFile[TypeVar("sas7bdat")], value=adsl_task["adsl_dataset"]),
    ...
    t_vscat_task = run_domino_job_task(
        ...
        command="prod/tfl/t_vscat_slc.sas",
